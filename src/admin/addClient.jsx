              ...
              >
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <button
                    ...
                    className={`w-full px-4 py-3 rounded-lg font-semibold transition-all duration-300 hover:scale-[1.02]4 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl ${
                      client.active
